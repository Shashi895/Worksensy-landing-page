...
const Navbar = ({ onOpenWaitlist }) => {
  ...
  return (
    <>
      ...
      <div
        className="fixed top-0 left-0 right-0 z-40 h-8 backdrop-blur-md"
        style={{
          background:
            "linear-gradient(to bottom, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.6) 70%, rgba(255,255,255,0) 100%)",
        }}
      />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-400 font-medium uppercase tracking-tight mt-1">
                  Operations OS for Modern Teams
                </span>
              </div>
              {/* Divider */}
              <div className="" />
